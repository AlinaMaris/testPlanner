...
export function Textarea({ variant = 'default', className = '', ...props }: TextareaProps) {
  const baseClasses = "w-full p-3 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 bg-white/90 backdrop-blur-sm resize-vertical min-h-[100px]";
